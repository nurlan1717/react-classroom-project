            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <RichTextEditor
                  ...
                  onChange={(content) =>
                    setEditedTask({ ...editedTask, description: content })
                  }
                />
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                {isTeacher && (
                  <button
                    ...
                    className="ml-2 px-4 py-2 bg-blue-100 text-blue-600 rounded-lg hover:bg-blue-200"
                  >
                    Edit Task
                  </button>
                )}
